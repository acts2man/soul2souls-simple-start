        ...
        <div className="tablet:mr-[70px] tablet:mt-[25px] tablet:w-1/2">
          ...
          <div className="mt-6 space-y-6 text-justify text-[18px] font-normal leading-[36px] text-e-gray">
            <p>
              ...
              <strong>immersive, high-quality jazz experiences</strong> that blend various genres of
              jazz and live show vibes.
            </p>
            <p>
              ...
              flavor to every episode — one that’s grounded in authenticity, musical excellence, and
