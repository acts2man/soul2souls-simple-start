    ...
    <section className="bg-[#190924] px-4 py-[60px] text-white">
      <div className="mx-auto max-w-[1230px] text-center">
        ...
        <p className="mx-auto mt-6 max-w-[1100px] font-poppins leading-[35px]">
          ...
          on the global charts! A huge thank you to our amazing listeners and supporters around the
          world – your love for jazz keeps the soul in the music alive. Our mixes blend smooth
          rhythms, vibrant melodies and cool Jazz grooves that are clearly resonating throughout
          communities around the globe. If you haven’t heard it yet, now’s the perfect time to dive
          into the vibe. Let’s keep the momentum going, fingers snapping and continue to advance
          rapidly in the entertainment sectors! Stay tuned, stay blessed and stay soulful!
        </p>
      </div>
    </section>
  );
