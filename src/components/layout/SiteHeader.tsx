...
export function SiteHeader() {
  return (
    <header className="absolute inset-x-0 top-0 z-[99]">
      ...
      <div className="fixed right-0 top-[40vh] z-[9999] hidden flex-col items-center desktop:flex">
        <div className="absolute -top-[34px] right-[14.5px] origin-bottom-right rotate-90 rounded-t-[6px] rounded-br-[6px] bg-brand-purple-dark px-5 pb-[10px] pt-[5px]">
        ...
        <SocialLinks
          ...
          className="bg-brand-purple px-[15px] pb-[30px] pt-[40px] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.5)]"
        />
      </div>
    </header>
  );
